...
test.describe('Check AWS policies', () => {
    ...
    test.only('environment max duration test ', async () => {
        ...
        await goToSpace(page, space);
        await launchBlueprintFromCatalogPage(page, 's3', inputs)
        // const popup = await page.locator('[data-testid="collapsable-error-details"]')
        // page.Frame().waitForSelector('.error-details-text')
        await page.waitForTimeout(2000);
        expect(await page.locator('.modal-body-section')).toContain('You are not allowed to perform this action' , {timeout:5000})
